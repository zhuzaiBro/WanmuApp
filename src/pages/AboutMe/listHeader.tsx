...
export default function Header({ list = [
    ...
    const RnederItem = ({ item, index }) => {
        return (
            <Pressable onPress={() => {
                ...
                <Text style={{ ...styles.headerFont, color: "#000000e5", fontWeight: currentIndex === index ? "700" : "400" }}>
                    {item.name}
    ...
    return (<View style={{
        ...
        <View style={{
            ...
            height: ROATE(44), flexDirection: "row", alignItems: "center",paddingHorizontal: ROATE(16)
        }}>
            {List}
