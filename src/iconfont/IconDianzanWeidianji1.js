...
let IconDianzanWeidianji1 = ({ size, color, ...rest }) => {
  return (
    <SvgXml xml={xml}  width={size} height={size} {...rest} />
  );
};

IconDianzanWeidianji1.defaultProps = {
  size: 18,
};

IconDianzanWeidianji1 = React.memo ? React.memo(IconDianzanWeidianji1) : IconDianzanWeidianji1;

export default IconDianzanWeidianji1;
