...
let IconTanchuangGuanbi = ({ size, color, ...rest }) => {
  return (
    <SvgXml xml={xml}  width={size} height={size} {...rest} />
  );
};

IconTanchuangGuanbi.defaultProps = {
  size: 18,
};

IconTanchuangGuanbi = React.memo ? React.memo(IconTanchuangGuanbi) : IconTanchuangGuanbi;

export default IconTanchuangGuanbi;
