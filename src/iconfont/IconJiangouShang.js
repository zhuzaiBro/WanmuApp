...
let IconJiangouShang = ({ size, color, ...rest }) => {
  return (
    <SvgXml xml={xml}  width={size} height={size} {...rest} />
  );
};

IconJiangouShang.defaultProps = {
  size: 18,
};

IconJiangouShang = React.memo ? React.memo(IconJiangouShang) : IconJiangouShang;

export default IconJiangouShang;
